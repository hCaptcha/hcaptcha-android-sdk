...
final class HCaptchaDebugInfo implements Serializable {
    ...
    public String getSysDebug() {
        ...
        synchronized (this) {
            ...
            try {
                Map<String, String> props = roBuildProps();
                final ObjectMapper objectMapper = new ObjectMapper();
        ...
        try {
            ...
            try (BufferedReader br = new BufferedReader(
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    String[] parsedLine = entry.toString().split("]: \\[");
                    String key = parsedLine[0].substring(1); // strip first [
                    if (key.startsWith("ro")) {
                        String value = parsedLine[1].substring(0, parsedLine[1].length() - 2); // strip last ]
                        props.put(key, value);
                    }
                }
            }
