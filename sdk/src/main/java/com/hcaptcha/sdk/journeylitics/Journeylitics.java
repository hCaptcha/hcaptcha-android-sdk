...
public class Journeylitics {
            ...
            new Application.ActivityLifecycleCallbacks() {
                ...
                public void onActivityResumed(Activity activity) {
                    if (sConfig.isEnableScreens()) {
                        final Map<String, String> meta = MetaMapHelper.createMetaMap(
    ...
    public static void emit(EventKind kind, String view, Map<String, String> metadata) {
            ...
            public void onProgressChanged(SeekBar bar, int progress, boolean fromUser) {
                ...
                if (fromUser && sConfig.isEnableSliders()) {
                    final Map<String, String> meta = MetaMapHelper.createMetaMap(
                        ...
                        new AbstractMap.SimpleEntry<>(FieldKey.VALUE, String.valueOf(progress))
                    );
                ...
                if (sConfig.isEnableSearch()) {
                    final Map<String, String> meta = MetaMapHelper.createMetaMap(
                        ...
                        new AbstractMap.SimpleEntry<>(FieldKey.VALUE,
                            query != null ? String.valueOf(query.length()) : "0")
                    );
        ...
        editText.addTextChangedListener(new android.text.TextWatcher() {
            ...
            public void afterTextChanged(android.text.Editable editable) {
                ...
                if (currentLength != previousLength) {
                    ...
                    final String value = String.valueOf(delta);
                    ...
                    final Map<String, String> meta = MetaMapHelper.createMetaMap(
                        ...
                        new AbstractMap.SimpleEntry<>(FieldKey.VALUE, value)
                    );
                    ...
                    final Map<String, String> meta = MetaMapHelper.createMetaMap(
                        ...
                        new AbstractMap.SimpleEntry<>(FieldKey.VALUE,
                            editText.getText() != null
                                ? String.valueOf(editText.getText().length()) : "0")
                    );
                    emit(EventKind.edit, editText.getClass().getSimpleName(), meta);
                }
                return handled;
